        ...
        // <div className="everything-card mt-10">
            <div className="everything-card flex flex-wrap p-5 gap-1 mb-1">
                ...
                <div className="everything-card-img mx-auto">
                    <img src={props.imgUrl} alt="image" className="everything-card-img" />
                </div>
                ...
                <div className="info">
                    <div className="source-info flex items-center gap-2">
                        ...
                        <a href={props.url} target="_blank" rel="noopener noreferrer" className="link underline break-words">
                    ...
                    <div className="origin flex flex-col">
                        <p className="origin-item">
                            <span className="info-item">Author: </span> {props.author}
                        </p>
                        <p className="origin-item">
                            <span className="info-item">Published At: </span> ({props.publishedAt})
                        </p>
                    </div>
                </div>
            {/* </div> */}
